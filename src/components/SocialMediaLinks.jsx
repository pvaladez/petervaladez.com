...
export default function SocialMediaLinks({ className }) {
  ...
  return (
    <ul
      className={className || styles.socialMedia}
    ...
    >
      ...
      <li>
        <a href={contact.stackoverflow_url} aria-label="stackoverflow">
          <Icon icon={stackoverflowIcon} aria-hidden="true" />
        </a>
      </li>
      <li>
        <a href={contact.twitter.url} aria-label="twitter">
          <Icon icon={twitterIcon} aria-hidden="true" />
        </a>
      </li>
      <li>
        <a href={contact.devto_url} aria-label="dev.to">
          <Icon icon={devToIcon} aria-hidden="true" />
        </a>
      </li>
    </ul>
  );
